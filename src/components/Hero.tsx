...
export default function Hero() {
  return (
    ...
    >
      ...
      {/* Hexagonal glow blobs — from Stitch design */}
      <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden">
        ...
        {[
          ...
          <motion.div
            key={i}
            className="absolute"
            style={{ top: h.top, left: h.left, right: (h as {right?: string}).right }}
      ...
      {/* Two-column layout — from Stitch design */}
      <div className="relative z-10 max-w-6xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="flex flex-col gap-7">
          ...
          >
            Visualize renovations, estimate costs, and find the right professionals — all in one AI-powered platform built for property investors.
          </motion.p>
        ...
        {/* Right: AI-generated room preview — from Stitch design */}
        <motion.div
          custom={2} variants={fadeUp} initial="hidden" animate="visible"
