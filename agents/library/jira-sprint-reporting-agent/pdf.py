...
STR = {
 ...
 "es": {
  ...
  "story": ["<strong>El alcance creció a mitad del sprint.</strong> Se añadieron 7 ítems después de iniciar el sprint; el equipo completó 4. Los 3 que se trasladaron son bugs reactivos de registro de propietarios - la razón por la que ahora existe un <strong>bucket de Bugs de Producción</strong> en el Sprint 4.",
            ...
            "<strong>Dos historias de la época de UAT siguen bloqueadas por el CEO.</strong> Crear Tipo de Usuario Vendedor (RAI-437) y la actualización del acuerdo de corretaje White-Glove (RAI-622) se han trasladado desde UAT, esperando la decisión del acuerdo de corretaje y los precios White-Glove. Seguirán trasladándose hasta que se tome esa decisión.",
