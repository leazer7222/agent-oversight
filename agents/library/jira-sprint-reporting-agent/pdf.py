...
STR = {
 "en": {
  ...
  "badge": "SPRINT HEALTH: GREEN &middot; GOAL SUBSTANTIALLY MET",
  "kpi": [("Sprint Goal","4 / 6","green","pillars complete"),
 ...
 "es": {
  ...
  "badge": "ESTADO DEL SPRINT: VERDE &middot; OBJETIVO MAYORMENTE CUMPLIDO",
  "kpi": [("Objetivo","4 / 6","green","pilares completos"),
  ...
  "story": ["<strong>El alcance creció a mitad del sprint.</strong> Se añadieron 7 ítems después de iniciar el sprint; el equipo completó 4. Los 3 que se trasladaron son bugs reactivos de registro de propietarios - la razón por la que ahora existe un <strong>bucket de Bugs de Producción</strong> en el Sprint 4.",
            ...
            "<strong>Dos historias de la época de UAT siguen bloqueadas por el CEO.</strong> Crear Tipo de Usuario Vendedor (RAI-437) y la actualización del acuerdo de corretaje White-Glove (RAI-622) se han trasladado desde UAT, esperando la decisión del acuerdo de corretaje y los precios White-Glove. Recomendación: si el acuerdo de corretaje y los precios no se definen, retirar la funcionalidad del Módulo de Vendedor (RAI-437) de la aplicación hasta que se definan, en vez de exponer funcionalidad de vendedor sin los términos legales y de precios establecidos.",
